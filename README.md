...
A full-stack web application built using the MERN stack for creating, managing, and participating in events with ease. The system also includes AI-based recommendations, analytics, and user engagement features.
